...
const OnePoint = () => {
  ...
  const handleCalculate = () => {
    ...
    try {
      const solver = new OnePointJS(params.x0, params.equation, params.tolerance)
    ...
    <div className='text-white'>
      ...
      <div className='min-h-screen bg-gradient-to-b from-blue-900 to-black py-[90px]'>
        <div className='container mx-auto px-4'>
          <h1 className='text-4xl font-bold'> <span className='text-gradient'>One Point Iteration</span> Method</h1>
        ...
        <div className='mx-auto mt-10 max-w-6xl rounded-xl border border-blue-700/40 
          ...
          <PlotWithTailwind
            ...
            graphName="One Point Iteration Graph"
          />
        </div>
